...
/// The original source of a message, indicating where it came from.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum Original {
    /// The message originated from a Discord user.
    Discord {
        /// The Discord user ID of the sender.
        user_id: UserId,
        // message: Box<DiscordMessage>,
    },
    /// The message was generated by an `OpenAI` model.
    OpenAi {
        /// The character's ID.
        character: String,
    ...
    /// The message was generated by the Rig agent.
    Rig {
        /// The character's ID.
        character: String,
        /// The character's name.
    ...
    /// The message was generated by a character.
    Character {
        /// The character's ID.
        id: String,
        /// The character's name.
    ...
    /// The message is an example message.
    ExampleMessage {
        /// The Discord user ID of the user who sent the example.
        user_id: UserId,
    },
...
impl Message {
    ...
    ///
    /// Unsplit on newlines.
    pub fn new_user<A, C, U>(author: A, content: C, user_id: U) -> Self
    where
        A: Into<String>,
        C: Into<String>,
        U: Into<UserId>,
...
impl Parts {
    ...
    /// Returns all the remaining (tail) parts of the message.
    #[must_use]
